            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseMenu1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="#"><i class="fa-solid fa-id-card me-2"></i>ข้อมูลส่วนตัว</a>
                        <a class="nav-link" href="#"><i class="fa-solid fa-briefcase me-2"></i>ข้อมูลการทำงาน</a>
                        <a class="nav-link" href="#"><i class="fa-solid fa-key me-2"></i>เปลี่ยนรหัสผ่าน</a>
                    </nav>
                </div>
