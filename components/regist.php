            ...
            <div class="row justify-content-center p-2">
                <div class="card shadow-lg col-lg-9 col-xl-9">
                    <div class="card-body p-0">
                        ...
                        <!-- Regist form-->
                        <form class="form" method="POST" action="test.php" enctype="multipart/form-data">
                        <div class="col mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            autocomplete="off" required placeholder="เลขที่ ตึก ถนน ซอย ฯลฯ" maxlength="50">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div id="c_telCol" class="col-md-6 mb-2" style="display:none;">
                                            ...
                                            autocomplete="off" maxlength="15" minlength="9">
                                        </div>
                                        <div id="c_webCol" class="col-md-6 mb-2" style="display:none;">
                                            ...
                                            autocomplete="off" placeholder="http://www.example.co.th" maxlength="50">
                                        </div>
                                        <div id="c_addressCol" class="col-12 mb-2" style="display:none;">
                                            ...
                                            autocomplete="off" placeholder="เลขที่ ตึก ถนน ซอย ฯลฯ" maxlength="50">
                                        </div>
                                        <div id="c_provinceCol" class="col-md-6 mb-2" style="display:none;">
                                            จังหวัด<span class="text-danger"> *</span>
                                            <select id="province2" class="form-select" name="c-address4">
                                                <option value="" selected disabled>--กรุณาเลือก--</option>
                                                <?php foreach ($query_address as $value) { ?>
                                                <option value="<?=$value['name_in_thai']?>" data-id="<?=$value['id']?>"><?=$value['name_in_thai']?></option>
                                                <?php } ?>
                                        ...
                                        <div id="c_districtCol" class="col-md-6 mb-2" style="display:none;">
                                            อำเภอ/เขต<span class="text-danger"> *</span>
                                            <select id="district2" class="form-select" name="c-address3">
                                                <option value="" selected disabled>--กรุณาเลือก--</option>
                                            </select>
                                        </div>
                                        <div id="c_subdistrictCol" class="col-md-6 mb-2" style="display:none;">
                                            ตำบล/แขวง<span class="text-danger"> *</span>
                                            <select id="subdistrict2" class="form-select" name="c-address2">
                                                <option value="" selected disabled>--กรุณาเลือก--</option>
                                            </select>
                                        </div>
                                        <div id="c_zipcodeCol" class="col-md-6 mb-2" style="display:none;">
                                            รหัสไปรษณีย์<span class="text-danger"> *</span>
                                            <input id="zipcode2" class="form-control" type="text" name="c-address5" Value=""
                                            autocomplete="off" readonly maxlength="5">
                                        </div>
                                    </div>
                                </div>
...
<?php include('resource/ajax-scripts/ajax-facultySelect-script.php');?>
<?php include('resource/ajax-scripts/ajax-yearSelect-script.php');?>
<?php include('resource/ajax-scripts/ajax-addressSelect-script.php');?>
<?php include('resource/ajax-scripts/jobform-script.php');?>